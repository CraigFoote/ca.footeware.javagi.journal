...
### An encrypyed daily journal for flatpak.
...
I haven't created a release yet because I'm still working on core features. Once I do, you'll find a .flatpak file in the [Releases](https://github.com/CraigFoote/ca.footeware.javagi.journal/releases) page. Double-clicking it should open it in the GNOME Software application allowing installation.
...
The jar is a fat jar with embedded dependencies and can be run at command line using:

`java -jar journal-0.0.1-SNAPSHOT.jar`



But we're building it into a flatpak installer. From the *app* folder, run the following to build the flatpak and install it locally.
