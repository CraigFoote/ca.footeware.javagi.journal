...
The code is compiled with Java 25 and is packaged in a flatpak container with runtimes *org.gnome.Platform* 50, *org.gnome.Sdk* 50, and *org.freedesktop.Sdk.Extension.openjdk25* that includes the openjdk-25 JRE that runs the Journal application.
